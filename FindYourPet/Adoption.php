...
<input type="text" id="location" name="location" class="field-input col-2">
</div>
<div class="field">
<label for="animal" class="field-label">Category</label>
<select class="field-input col-2" id="type" name="typee"  onclick="window.getbreed();">
    <option></option>
  <option>Dog</option>
  <option>Cat</option>
...
<select class="field-input col-2" name="breed" id="inputbreed" style="width: 110px;" ></select>
</div>
<div class="field gender">
<label for="animal" class="field-label">Gender</label>
<select class="field-input col-2" id="gender" name="gender">
<option></option>
  <option >Male</option>
...
<select class="field-input col-2" id="age" name="age" >
<option></option>
  <option>Baby</option>
  <option>Young</option>
  <option>Adult</option>
...
<input type="submit" name="submit" class="field-input col-2" id="button" style="border-radius: 20px;transform: translateY(20px); margin-left: 10px; margin-right: 15px" onclick="validate();" ></input>
